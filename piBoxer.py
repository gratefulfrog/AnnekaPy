...
class seeker(threading.Thread):
    def __init__(self,q,foundEvt,lk):
...
if __name__ == '__main__':
    ...
    if len(sys.argv)==2:
        ...
        run(n)
        print('Elapsed time :','{:,}'.format(time.time()-start), 'seconds')
    else:
